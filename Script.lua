...
local inline = {{{text="قناه‏‏ السـورس : السلام ",url="t.me/tft4t"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: السلام](t.me/tft4t)',nil,inline,msg.id_)
return false
end
...
if MsgText[1] == "فواز مطور السورس"  then
