...
if UserID == 819385837 or UserID == 1619524486 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 819385837 or UserID == 1619524486 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
NameUser = Hyper_Link_Name(data)
if UserID == 819385837 or UserID == 1619524486 then 
...
if FwdUser == 819385837 or FwdUser == 1619524486 then 
