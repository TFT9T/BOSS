...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "tft4t"))
end
end
...
elseif UserID == 656329268 or UserID == 1619524486  then  
...
--=======================================================
--=======================================================
if MsgText[1] == "مسح المنشئيين الاساسيين" or MsgText[1] == "مسح المنشئين الاساسيين" or MsgText[1] == "مسح الاساسيين" or MsgText[1] == "مسح المنشئين الاساسين" then 
if not msg.SuperCreator then return "- هذا الامر يخص {المطور,المالك} فقطط  \n" end
...
if UserID == 656329268 or UserID == 1619524486then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 656329268 or UserID == 1619524486then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
local inline = {{{text="قناه‏‏ السـورس : اباظـة ",url="t.me/tft4t"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: اباظـة](t.me/tft4t)',nil,inline,msg.id_)
return false
end
...
local text = " [مطور السورس🌐 ](t.me/bbqq8)"
local inline = {
...
local text = " 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝙋𝙀𝘼𝘾𝙀 ⩫ "
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙋𝙀𝘼𝘾𝙀 ⩫ ',url="https://t.me/tft4t"}},
{{text = '-𝘿𝙀𝙑   👑',url="https://t.me/bbqq8"}},
{{text = '-𝙏𝙒𝘼𝙎𝙊𝙇 💬 ',url="https://t.me/peace1bot"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
...
NameUser = Hyper_Link_Name(data)
if UserID == 656329268 or UserID == 1619524486then 
...
if msg.adduser == 656329268 or msg.adduser ==  1619524486 then 
gtupe = 'مطور السورس' 
...
elseif Text== "باسل" or Text== "بيسو" or Text== "بسله" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس👑](T.ME/bbqq8)")
